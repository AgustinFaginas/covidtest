    ...
    <div class="container">
        ...
        <form:form action="detallePaciente" method="POST" modelAttribute="paciente" role="form" class="contactForm">
                        ...
                        <h4>Tipo de documento</h4>
		                     ...
		                     <form:select path="tipoDocumento" id="tipoDocumento" type="TipoDocumento" class="form-control br-radius-zero" >
                        ...
                        <div class="form-action">
                            <button type="submit" class="btn btn-form">Consultar Paciente</button>
                        </div>
                        <br>
                        <div class="form-group">
