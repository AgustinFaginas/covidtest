...
<h1 class="text-center mb-3 mt-5">Permiso denegado</h1>

<div class="text-center my-5">
    <img src="img/cancel.png" class="rounded" alt="denied" width="350" height="350">
</div>

<h2 class="text-center my-3 mb-5">Su permiso no pudo ser gestionado debido a que usted no posee la mayoría de edad para
    salir fuera de su hogar</h2>

<h3 class="text-center my-5">Compruebe su estado cada 48hs y recuerde seguir los consejos para prevenir el
    Coronavirus</h3>
